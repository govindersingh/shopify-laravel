...
return [
    ...
    */
    ...
    'manual_migrations' => (bool) env('SHOPIFY_MANUAL_MIGRATIONS'),
    ...
    */
    ...
    'billing_enabled' => (bool) env('SHOPIFY_BILLING_ENABLED'),
    ...
    'webhooks' => [
        ...
        /*
            [
                ...
                'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', env('APP_URL') . '/webhook/purchase'),
            ]
            ...
        */
    ],
    ...
    */
    ...
    'scripttags' => [
		[
			'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', env('APP_URL') . '/scripttags/shopifyApp.js'),
